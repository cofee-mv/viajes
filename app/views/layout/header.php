	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="flex justify-between h-16 items-center">
			...
			<nav class="hidden md:flex space-x-4">
				<a href="/viajes/public/index.php?page=login" class="text-gray-600 hover:text-green-600">Iniciar Sesión</a>
				<a href="/viajes/public/index.php?page=register" class="text-gray-600 hover:text-green-600">Registrarse</a>
				...
				<?php if (!empty($_SESSION['rol_id']) && $_SESSION['rol_id'] == 1): ?>
					<a href="/viajes/public/index.php?page=admin" class="text-purple-600 hover:text-purple-700 font-semibold">Panel Admin</a>
				<?php endif; ?>
				<?php if (!empty($_SESSION['rol_id']) && $_SESSION['rol_id'] == 2): ?>
					<a href="/viajes/public/index.php?page=empleado" class="text-blue-600 hover:text-blue-700 font-semibold">Panel Empleado</a>
				<?php endif; ?>
				<a href="/viajes/public/index.php?page=logout" class="text-gray-600 hover:text-red-600">Cerrar Sesión</a>
			</nav>
