...
<body class="bg-gray-100 min-h-screen">
    ...
    <main class="max-w-6xl mx-auto p-6">
        ...
        <p class="text-gray-600 mb-6">Haz clic en un destino para continuar (serás redirigido a la página de inicio de
            sesión).</p>

        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <?php
            $destinos = [
                ['nombre' => 'Bogotá', 'pais' => 'Colombia', 'imagen' => 'bogota_colombia.webp'],
                ['nombre' => 'Cartagena', 'pais' => 'Colombia', 'imagen' => 'cartagena.jpg'],
                ['nombre' => 'Cali', 'pais' => 'Colombia', 'imagen' => 'cali.webp'],
                ['nombre' => 'Barranquilla', 'pais' => 'Colombia', 'imagen' => 'barranquilla.jpg'],
            ];
            ...
            foreach ($destinos as $dest):
                ...
                <a href="<?= $url ?>" class="block bg-white rounded-xl shadow hover:shadow-lg transition p-5">
                    <div class="flex flex-col items-center justify-between">
                        <img src="./img/<?= htmlspecialchars($dest['imagen']) ?>"
                            alt="<?= htmlspecialchars($dest['nombre']) ?>" class="w-full h-32 object-cover rounded-lg">
